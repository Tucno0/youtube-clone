...
export const videoRelations = relations(videos, ({ one, many }) => ({
  user: one(users, {
    // Define one-to-one relation with users table
    fields: [videos.userId],
    references: [users.id],
  }),
  category: one(categories, {
    // Define one-to-one relation with categories table
    fields: [videos.categoryId],
    references: [categories.id],
  }),
  views: many(videoViews), // Define one-to-many relation with video_views table
  reactions: many(videoReactions), // Define one-to-many relation with video_reactions table
  comments: many(comments), // Define one-to-many relation with comments table
  playlistVideos: many(playlistVideos), // Define one-to-many relation with playlist_videos table
}));
...
export const commentRelations = relations(comments, ({ one, many }) => ({
  ...
  reactions: many(commentReactions), // Define one-to-many relation with comment_reactions table
