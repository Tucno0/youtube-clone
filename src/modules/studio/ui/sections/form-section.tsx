...
export const FormSectionSuspense = ({ videoId }: FormSectionProps) => {
  ...
  const generateTitle = trpc.videos.generateTitle.useMutation({
    onSuccess: () => {
      toast.success("Background title generation job started", {
        description: "This may take a few minutes to complete",
      });
    },
  ...
  const generateDescription = trpc.videos.generateDescription.useMutation({
    onSuccess: () => {
      toast.success("Background description generation job started", {
        description: "This may take a few minutes to complete",
      });
    },
                        ...
                        <DropdownMenu>
                          <DropdownMenuTrigger asChild>
                            <Button
                              type="button"
                              size={"icon"}
                              className="bg-black/50 hover:bg-black/75 absolute top-1 right-1 rounded-full opacity-100 md:opacity-0 group-hover:opacity-100 duration-300 size-7"
                            >
                          ...
                          <DropdownMenuContent align="start">
                            ...
                            <DropdownMenuItem
                              ...
                              disabled={
                                generateThumbnail.isPending || !video.muxTrackId
                              }
                            >
